...
| `neo-linoleum-original-tiles.zip` | 8×8 Original | GPL v2 or the Angband licence |
| `neo-linoleum-adam-bolt.zip` | 16×16 Adam Bolt | redistributable and modifiable for any purpose |
| `neo-linoleum-gervais.zip` | 32×32 David Gervais | Creative Commons Attribution 3.0 |
| `neo-linoleum-nomad.zip` | 8×16 Nomad | GPL v2 or the Angband licence |
| `neo-linoleum-shockbolt-dark.zip` | 64×64 Shockbolt, Dark | © Raymond "Shockbolt" Gaustadnes 2012 — see below |
| `neo-linoleum-shockbolt-light.zip` | 64×64 Shockbolt, Light | © Raymond "Shockbolt" Gaustadnes 2012 — see below |
